...
public class predictNodeTask extends AbstractTask {
    private static final String SERVER_URL = "http://localhost:5000/predict_node_label";
    private final CyApplicationManager applicationManager;

    public predictNodeTask(CyApplicationManager applicationManager) {
