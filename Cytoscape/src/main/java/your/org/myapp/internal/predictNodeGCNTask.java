...
public class predictNodeGCNTask extends AbstractTask {
    private static final String SERVER_URL = "http://localhost:5000/predict_node_label_GCN"; // Updated URL for GCN prediction
    private final CyApplicationManager applicationManager;

    public predictNodeGCNTask(CyApplicationManager applicationManager) {
